...
public class Prestige extends Rank {
  ...
  protected Prestige(ConfigurationSection section, ArkonasRanksPlugin plugin, String next, String rank, RankRequirements requirements, List<String> commands, String from, String to) {
    super(section, plugin, next, rank, rank, requirements, commands);
    this.from = from;
    this.to = to;
  }

  public static Prestige deserialize(ArkonasRanksPlugin plugin, ConfigurationSection section) {
